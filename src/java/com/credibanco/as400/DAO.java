...
public class DAO {
    ...
    public void conectar() throws Exception {
        try {
            ...
            cn = DriverManager.getConnection( "jdbc:as400://172.16.0.20/ESTABLE", "CANALAPP", "ge3espEx" );
            //cn = DriverManager.getConnection( "jdbc:as400://172.26.23.11/ESTABLE", "CBDINTER01", "CDNE0VISA" );
        } catch ( Exception exc ) {
